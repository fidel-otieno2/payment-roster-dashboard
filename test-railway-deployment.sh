...
# Usage: ./test-railway-deployment.sh <railway-backend-url>

if [ $# -eq 0 ]; then
    echo "Usage: $0 <railway-backend-url>"
    echo "Example: $0 https://payment-roster-backend.up.railway.app"
    exit 1
fi

BACKEND_URL=$1

echo "Testing Railway deployment at: $BACKEND_URL"
echo "=========================================="
